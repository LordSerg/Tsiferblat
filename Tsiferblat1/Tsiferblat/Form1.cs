...
namespace Tsiferblat
{
    public partial class Form1 : Form
    {
        ...
        private void SetQwestion()
        {
            ...
            ShowNewQwestion();//красивая анимация
        }
        ...
        {//OK
            //if (lvl > WinLvlNum) peremoga = true;
            if (!peremoga)
            {
                if (label1.Text != "---")
                    ChangeAnswer();
        ...
        {//отрисовка попиксельного "превращения"
            //1. разделяем на пиксели
            //2. заносим их в 2д булевый массив
            //3. в таймере снизу вверх(или по другому алгоритму) каждый пиксель проходит три стадии:
            //а)побеление
            //б)почернение
            //в)нужный цвет
            //
